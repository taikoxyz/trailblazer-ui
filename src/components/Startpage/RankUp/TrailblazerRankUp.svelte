		...
		<div class="flex flex-col xl:flex-row">
			...
			<div class="flex flex-col xl:w-1/2 w-full">
				...
				<div class="mt-[50px] mb-[40px]">
					Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam harum delectus
					accusantium ab alias modi nobis non a explicabo id, illo corporis perferendis facere, esse
					praesentium rem odit iure minus.
				</div>
