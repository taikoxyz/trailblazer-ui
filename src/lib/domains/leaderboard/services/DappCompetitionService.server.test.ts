...
// Mock the server adapters and repository
...
describe('DappCompetitionService', () => {
  ...
  beforeEach(() => {
    ...
    // Instantiate the server adapters (using dummy constructor args)
    mockCompetitionAdapter = new DappCompetitionAdapter('dummy', 1) as Mocked<DappCompetitionAdapter>;
