<script lang="ts">
  ...
  export function scrollLeft() {
    carouselElement.scrollBy({ left: -300, behavior: 'smooth' }); // Adjust -300 to the size of your carousel items or desired scroll amount
  }

  export function scrollRight() {
    carouselElement.scrollBy({ left: 300, behavior: 'smooth' }); // Adjust 300 similarly
  }
</script>
