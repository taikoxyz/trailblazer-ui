...
export const ensCarouselItems: CarouselItemType[] = [
  {
    id: '1',
    title: 'DotTaiko (SpaceID)',
    description: 'DotTaiko is the web3 domain naming service built for the Taiko blockchain community. ',
    image: '/dapps/ens/dottaiko.svg',
  ...
  },
  {
    ...
    image: '/dapps/ens/pop-planet.svg',
    link: 'https://socialsummer.ai/',
    cta: 'Use now',
  },
];
